...
">
            ...
            <button className=" bg-[hsl(158,36%,37%)] rounded-lg text-white py-3.5 mb-6 mt-2 flex justify-center md:mt-3 "><img src=".//public/icon-cart.svg" alt="icon-cart" className=" mr-3" /><span>
                Add to Cart</span> 
